...
//if (app.Environment.IsDevelopment())    this if statement dose not allow acces if not in dev mode, remove this line to access swagger outside of devmode
//{
    app.UseSwagger();
    app.UseSwaggerUI();
//}
